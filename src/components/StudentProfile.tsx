  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="flex items-center gap-3 group mt-1">
        ...
        <button 
          onClick={handleEdit}
          className="opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-2 h-10 px-4 border border-border bg-white text-secondary font-mono text-[10px] uppercase tracking-widest hover:bg-background rounded-none shrink-0"
          ...
          <div className="space-y-6">
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                disabled={saving}
                className="w-full h-11 px-3 bg-background border border-border text-[14px] font-sans text-secondary placeholder:text-muted/50 outline-none transition-[border-color] duration-150 focus:border-secondary disabled:opacity-40 rounded-none"
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={saving}
                  className="w-full h-11 pl-8 pr-3 bg-background border border-border text-[14px] font-sans text-secondary placeholder:text-muted/50 outline-none transition-[border-color] duration-150 focus:border-secondary disabled:opacity-40 rounded-none"
                />
              </div>
            </div>
          </div>
