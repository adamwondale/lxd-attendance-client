    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-background text-secondary font-sans selection:bg-secondary selection:text-surface overflow-y-auto">
      <div className="w-full max-w-[440px] my-auto py-12">
        ...
        <div className="mb-8 text-center">
          <div className="w-12 h-12 bg-secondary text-surface flex items-center justify-center font-bold text-xl mb-6 rounded-none mx-auto">
            LXD
          </div>
          <h1 className="text-3xl font-serif leading-tight">Create Workspace</h1>
          <p className="text-muted mt-2">Set up your administrator profile.</p>
        </div>
        ...
        <div className="bg-surface border border-border p-8 rounded-none shadow-sm">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-5">
              <div>
                <label className="block text-[11px] uppercase tracking-widest font-mono text-muted mb-2">Company Name</label>
                <input
                  ...
                  className={`w-full h-[44px] px-3 bg-background border text-sm outline-none transition-colors rounded-none placeholder:text-muted/50 ${
                    errors.companyName ? "border-primary focus:border-primary" : "border-border focus:border-secondary"
                  }`}
                />
                {errors.companyName && (
              ...
              <div>
                <label className="block text-[11px] uppercase tracking-widest font-mono text-muted mb-2">Company Phone</label>
                <input
                  type="tel"
                  maxLength={15}
                  ...
                  className={`w-full h-[44px] px-3 bg-background border text-sm outline-none transition-colors rounded-none placeholder:text-muted/50 ${
                    errors.companyPhone ? "border-primary focus:border-primary" : "border-border focus:border-secondary"
                  }`}
                />
                {errors.companyPhone && (
                  <motion.p initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }} className="text-[11px] uppercase tracking-widest font-mono text-primary mt-2">
              ...
              <div>
                <label className="block text-[11px] uppercase tracking-widest font-mono text-muted mb-2">Work Email</label>
                <input
                  type="email"
                  {...register("companyEmail")}
                  className={`w-full h-[44px] px-3 bg-background border text-sm outline-none transition-colors rounded-none placeholder:text-muted/50 ${
                    errors.companyEmail ? "border-primary focus:border-primary" : "border-border focus:border-secondary"
                  }`}
                />
                {errors.companyEmail && (
                  <motion.p initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }} className="text-[11px] uppercase tracking-widest font-mono text-primary mt-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-[11px] uppercase tracking-widest font-mono text-muted mb-2">Admin Name</label>
                  <input
                    {...register("adminName")}
                    className={`w-full h-[44px] px-3 bg-background border text-sm outline-none transition-colors rounded-none placeholder:text-muted/50 ${
                      errors.adminName ? "border-primary focus:border-primary" : "border-border focus:border-secondary"
                    }`}
                  />
                  {errors.adminName && (
                    <motion.p initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }} className="text-[11px] uppercase tracking-widest font-mono text-primary mt-2">
              ...
              <div>
                <label className="block text-[11px] uppercase tracking-widest font-mono text-muted mb-2">Confirm Password</label>
                <input
                  type="password"
                  {...register("confirmPassword")}
                  className={`w-full h-[44px] px-3 bg-background border text-sm outline-none transition-colors rounded-none placeholder:text-muted/50 ${
                    errors.confirmPassword ? "border-primary focus:border-primary" : "border-border focus:border-secondary"
                  }`}
                />
        ...
        <p className="text-center text-[13px] text-muted mt-8">
          Already have an account? <Link href="/admin/login" className="text-secondary font-medium hover:underline underline-offset-4">Sign in</Link>
        </p>
      </div>
    </div>
  )
