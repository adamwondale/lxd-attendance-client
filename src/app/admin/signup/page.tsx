    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#F9F9F8] text-[#0A0A0A] font-sans selection:bg-[#0A0A0A] selection:text-[#FFFFFF] overflow-y-auto">
      <div className="w-full max-w-[440px] my-auto py-12">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-serif leading-tight">Create Company Profile</h1>
          <p className="text-[#878786] mt-2">Set up your company and administrator profile.</p>
        </div>
        ...
        <div className="bg-[#FFFFFF] border border-[#E5E5E4] p-8 rounded-xl shadow-sm">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            >
              {isSubmitting ? <Loader2 className="w-4 h-4 animate-spin" /> : <span>CREATE COMPANY PROFILE</span>}
            </button>
          </form>
        </div>
